...
const MainFooter = () => {
  return (
    <div className="w-full bg-custom-blue h-[20rem] p-8 text-white">
        ...
        <Link to={"https://9oz.co.kr"} className="ml-16 mb-5 hover:opacity-70 hover:cursor-pointer">나인온스 https://9oz.co.kr/</Link>
