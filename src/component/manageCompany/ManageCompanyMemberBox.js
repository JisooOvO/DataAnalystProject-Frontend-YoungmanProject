...
const ManageCompanyMemberBox = ({data}) => {
  ...
  return (
    <div className="w-full border h-fit border-black shadow-md rounded-xl p-5 pt-10">
      <div className="flex w-full justify-between items-center border border-x-0 border-t-0 pb-5 text-xl border-black">
      ...
      <div className="mt-5 w-full">
        <div className="border w-full h-fit border-black p-4 rounded-xl">
          ...
          <div className="sm:flex h-12 items-center gap-4 w-full mb-3 pl-2">
            ...
            <select id="searchRole" className="border border-black rounded-xl shadow-inner sm:w-[39.6%] pl-2 w-full h-12">
